...
namespace UB.Model
{
    public static class SettingsRegistry
    {
        ...
        public static string ChatTitleConnectcast = "Connectcast.tv";
                ...
                return new List<ChatConfig>()
                {
                    ...
                    new ChatConfig()
                    {
                        ...
                        Parameters = new List<ConfigField>() {
                            ...
                            new ConfigField() {  Name = "ApiToken", Label = "Api token", DataType = "Text", IsVisible = false, Value = String.Empty },
                            new ConfigField() {  Name = "Host", Label = "Host", DataType = "Text", IsVisible = false, Value = "irc.twitch.tv" },                            
                            new ConfigField() {  Name = "Port", Label = "Port", DataType = "Text", IsVisible = false, Value = "6667" },                            
                    ...
                    new ChatConfig()
                    {
                        ...
                        Parameters = new List<ConfigField>() {
                            ...
                            new ConfigField() {  Name = "OAuthToken", Label = "OAuth token", DataType = "Text", IsVisible = false, Value = String.Empty },
                            new ConfigField() {  Name = "ApiToken", Label = "Api token", DataType = "Text", IsVisible = false, Value = String.Empty },
                            new ConfigField() {  Name = "Host", Label = "Host", DataType = "Text", IsVisible = false, Value = "199.9.252.26" },                            
                            new ConfigField() {  Name = "Port", Label = "Port", DataType = "Text", IsVisible = false, Value = "80" },                            
                            new ConfigField("Info1", "Enter justinfan<anydigits> and fill channels to get readonly access", "Info", true, null),                            
                            new ConfigField("Info2", "Channels is comma separated list. Hashtag is optional. e.g: #xedoc, ipsum, #lorem", "Info", true, null),
                            new ConfigField() {  Name = "AuthTokenCredentials", Label = "Auth token credentials", DataType = "Text", IsVisible = false, Value = String.Empty },
                        }
                    ...
                    new ChatConfig()
                    {
                        ...
                        Parameters = new List<ConfigField>() {
                            ...
                            new ConfigField() {  Name = "LastFollowerTime", Label = "LastFollowerTime", DataType = "Text", IsVisible = false, Value = String.Empty },
                    ...
                    new ChatConfig()
                    {
                        ...
                        Parameters = new List<ConfigField>() {
                            ...
                            new ConfigField() {  Name = "MessageFormat", Label = "Message format", DataType = "Text", IsVisible = true, Value = "%from_%chatname_: %text" },
                    ...
                    new ChatConfig()
                    {
                        ...
                        Parameters = new List<ConfigField>() {
                            ...
                            new ConfigField() {  Name = "AuthToken", Label = "AuthToken", DataType = "Text", IsVisible = false, Value = String.Empty },
                            new ConfigField() {  Name = "UserId", Label = "UserId", DataType = "Text", IsVisible = false, Value = 0 },
                            new ConfigField() {  Name = "ChatToken", Label = "ChatToken", DataType = "Text", IsVisible = false, Value = String.Empty },
                            new ConfigField() {  Name = "ServerUri", Label = "Server Uri", DataType = "Text", IsVisible = false, Value = String.Empty },
                            new ConfigField("Info1", "Leave username and password empty and fill channels if you need readonly access", "Info", true, null),
                            new ConfigField("Info2", "Channels is comma separated list. Hashtag is optional. e.g: #xedoc, ipsum, #lorem", "Info", true, null),
                            new ConfigField() {  Name = "AuthTokenCredentials", Label = "Auth token credentials", DataType = "Text", IsVisible = false, Value = String.Empty },
                        }
